...
public class TotemWingsBlock extends TotemBlock {
    ...
    private static final VoxelShape NORTH_SHAPE = Block.createCuboidShape(1, 2, 7, 15, 14, 9);
    private static final VoxelShape EAST_SHAPE = Block.createCuboidShape(7, 2, 1, 9, 14, 15);
    private static final VoxelShape SOUTH_SHAPE = Block.createCuboidShape(1, 2, 7, 15, 14, 9);
    private static final VoxelShape WEST_SHAPE = Block.createCuboidShape(7, 2, 1, 9, 14, 15);
