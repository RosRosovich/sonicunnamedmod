...
public class GreenHillBushBlock extends PlantBlock {

    public static final MapCodec<GreenHillBushBlock> CODEC =
            createCodec(GreenHillBushBlock::new);

    public GreenHillBushBlock(Settings settings) {
        super(settings);
    }
